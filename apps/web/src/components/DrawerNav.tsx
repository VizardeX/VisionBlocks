...
export default function DrawerNav({
  ...
  const textMain = dark ? "text-neutral-100" : "text-gray-900";
  const textSub = dark ? "text-neutral-400" : "text-gray-600";
  const hover = dark ? "hover:bg-neutral-800" : "hover:bg-gray-100";
    ...
    <>
      ...
      >
        ...
        <nav className="p-2">
          ...
          <div className={`mt-3 mb-1 px-3 text-xs uppercase tracking-wide ${textSub}`}>Modules</div>
          <Link
            href="/module1"
            className={`block px-3 py-2 rounded-md ${hover} ${textMain}`}
            onClick={onClose}
